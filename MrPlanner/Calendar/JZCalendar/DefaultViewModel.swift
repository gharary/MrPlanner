...
class DefaultViewModel: NSObject {
    ...
    */
    lazy var events = [DefaultEvent(id: "0", title: "Traction", startDate:firstDate , endDate: firstDate.add(component: .hour, value: 1), page: "1-10"),
    DefaultEvent(id: "1", title: "Traction", startDate: secondDate, endDate: secondDate.add(component: .hour, value: 4), page: "10-20")]
